# Django settings for legacysite project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'legacyDB',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '((k9^w7yuj_gcml&amp;6nu9ia3xam2#1_k8c-7&amp;ov99840878xkx^'
...
ROOT_URLCONF = 'legacysite.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'legacysite.wsgi.application'
